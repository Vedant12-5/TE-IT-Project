          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <div class="bottom-border pb-3">
                <!-- <img src="admin.jpeg" width="50" class="rounded-circle mr-3">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-book text-light fa-lg mr-3"></i>Booking</a></li>
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-search text-light fa-lg mr-3"></i>Search</a></li>
      ...
      <div class="row">
        <div class="col-xl-10 col-lg-10 col-md-8 ml-auto">
          <div class="row pt-md-5 mt-md-3 mb-5">
            ...
            <table class="table table-bordered table-hover ml-3 mr-3">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Email_id</th>
              ...
              <?php
                ...
                while($row = mysqli_fetch_assoc($select_customer))
                {
                  ...
                  echo "<tr>";
                    ...
                    ?>
                      <td>
                        <form class="" action="status_edit.php" method="post">
                          <input type="hidden" name="edit_status" value="<?php echo $row['phone_no']; ?>">
                        <button type="submit" class="btn btn-success" name="editbtn">Mark</button>
                      </form>
                    </td>
                    <?php
                  echo "</tr>";
